...
import {
  AsignationActTeenComplete
} from "../../component-funcionality/models/asignationActTeen/asignationActTeenComplete";
@Component({
...
export class AsignationActTeenPrincipalComponent implements OnInit {
  ...
  navigateToForm() {
    this.router.navigate(['asignationActTeen-form']).then(() => {
